...
import (
	...
	scheme "github.com/iamrz1/client-go-practice-ho/pkg/client/clientset/versioned/scheme"
...
type CronTabInterface interface {
	Create(*v1.CronTab) (*v1.CronTab, error)
	Update(*v1.CronTab) (*v1.CronTab, error)
	...
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.CronTab, err error)
	CronTabExpansion
}
...
func newCronTabs(c *ExamplecrdV1Client, namespace string) *cronTabs {
	return &cronTabs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *cronTabs) Get(name string, options metav1.GetOptions) (result *v1.CronTab, err error) {
	result = &v1.CronTab{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("crontabs").
...
func (c *cronTabs) List(opts metav1.ListOptions) (result *v1.CronTabList, err error) {
...
func (c *cronTabs) Watch(opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cronTabs) Create(cronTab *v1.CronTab) (result *v1.CronTab, err error) {
	result = &v1.CronTab{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("crontabs").
...
func (c *cronTabs) Update(cronTab *v1.CronTab) (result *v1.CronTab, err error) {
	result = &v1.CronTab{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("crontabs").
...
func (c *cronTabs) Delete(name string, options *metav1.DeleteOptions) error {
...
func (c *cronTabs) DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *cronTabs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.CronTab, err error) {
	result = &v1.CronTab{}
